    ...
    >
      ...
      <div className="form-group">
        ...
        <p className="item-photo-hint">
          Vendors still get {quoteWindowDays(priority)} day{quoteWindowDays(priority) === 1 ? '' : 's'} to quote
          ({priority} default). Change this if you need the stock sooner or later than that.
        </p>
      </div>
